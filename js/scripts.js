...
// floating email collapse and open code
document.getElementById('close-btn').onclick = function() {
  document.getElementById('floating-email-form').style.display = 'none';
}

document.getElementById('contact-link').onclick = function() {
  document.getElementById('floating-email-form').style.display = 'block';
}